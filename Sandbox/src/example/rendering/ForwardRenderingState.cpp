...
ForwardRenderingState::ForwardRenderingState(sg::ogl::state::StateStack* t_stateStack)
...
void ForwardRenderingState::AddDirectionalLight(const std::string& t_sunTexturePath)
{
