...
void GameState::Render()
{
    ...
    GetContext().shaderManager->GetShaderProgram("simple")->SetUniform("transform", mvp);
...
void GameState::Init()
{
    ...
    m_projectionMatrix = GetContext().window->GetProjectionMatrix();
