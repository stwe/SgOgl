...
namespace sg::ogl::camera
{
    ...
    public:
        ...
        static constexpr auto DEFAULT_DISTANCE{ 10.0f };
        static constexpr auto MIN_DISTANCE{ 5.0f };
        static constexpr auto MAX_DISTANCE{ 50.0f };
        ...
        ThirdPersonCamera(Application* t_application, glm::vec3& t_playerPosition, glm::vec3& t_playerRotation);
    ...
    private:
        ...
        glm::vec3 m_playerRotation{ glm::vec3(0.0f) };
